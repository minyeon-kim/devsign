...
function MergeDrawer({ icon: Icon, title, aside, onClose, children }) {
  return (
    <div className="absolute top-0 right-0 bottom-0 z-40 flex w-[380px] max-w-full flex-col border-l border-white/10 bg-card/75 shadow-2xl backdrop-blur-xl animate-in slide-in-from-right duration-200">
