...
// Left sidebar shown while in the Merge Studio view — search + advanced
// filters (status, category, conflict level, due date) on top of the saved
// merge cards, plus the entry point for adding more files to a merge.
// Selecting a card is the "routing" trigger: MergeStudioWorkspace reacts to
